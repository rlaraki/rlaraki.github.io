            ...
            d3.json('../data/sexe_deaths_sankey/sexe_deaths_sankey_' + country + '.json').then(function(graph) {
                ...
                node.append("rect")
                    ...
                    .style("fill", function(d) {
                        if (d.name == 'Women') {
                            return d.color = '#ff7675';
                        } else if (d.name == 'Men') {
                            return d.color = '#74b9ff';
                        } else if (d.name == 'Deaths') {
                            return d.color = '#c23616';
                        } else if (d.name == 'Confirmed cases without death') {
                ...
                node.append("text")
                    .attr("x", -6)
                    .attr("y", function(d) {
                        if (d.name == 'Confirmed cases without death') {
                            return d.dy / 5;
                        } else {
                            return d.dy / 2;
                        }
